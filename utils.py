...
RPCS = {
    ...
    'bsc' : {'chain': 'BSC', 'chain_id': 56, 'rpc': 'https://bsc-dataseed.binance.org', 'scan': 'https://bscscan.com/tx', 'token': 'BNB'},
    ...
    'celo' : {'chain': 'CELO', 'chain_id': 42220, 'rpc': 'https://1rpc.io/celo', 'scan': 'https://explorer.celo.org/mainnet/tx', 'token': 'CELO'},
}
